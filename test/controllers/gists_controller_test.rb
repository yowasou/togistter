...
class GistsControllerTest < ActionController::TestCase
  ...
  test "should create gist" do
    assert_difference('Gist.count') do
      post :create, gist: { code: @gist.code, codetype_id: @gist.codetype_id, description: @gist.description, gisturl: @gist.gisturl, matome_id: @gist.matome_id, user_id: @gist.user_id }
    end
  ...
  test "should update gist" do
    patch :update, id: @gist, gist: { code: @gist.code, codetype_id: @gist.codetype_id, description: @gist.description, gisturl: @gist.gisturl, matome_id: @gist.matome_id, user_id: @gist.user_id }
    assert_redirected_to gist_path(assigns(:gist))
  end
